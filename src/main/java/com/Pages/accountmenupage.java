...
//	private By savechange=By.xpath("");
	...
	private By Cancelbtn=By.xpath("(//button[text()='Cancel'])[2]");
	...
	private By Executorphone=By.xpath("(//input[@id='phone'])[2]");
	private By send=By.xpath("//button[contains(text(),'Send invitation')]");	
	private By close=By.xpath("(//button[@class='btn-close'])[2]");
	...
	private By closeall =By.xpath("//body/ngb-modal-window[1]/div[1]/div[1]/app-activity-completion-popup[1]/div[1]/div[1]/button[1]");
		...
		public void fields() {
			...
			FirstnameField.sendKeys("ramya");
			WebElement LastnameField=wait.until(ExpectedConditions.elementToBeClickable(lastname));
			LastnameField.sendKeys("tet");
			WebElement ChangezipcodeField=wait.until(ExpectedConditions.elementToBeClickable(changezipcode));
			ChangezipcodeField.sendKeys("50008");
			WebElement PhoneField=wait.until(ExpectedConditions.elementToBeClickable(phone));
			PhoneField.clear();
			PhoneField.sendKeys("+18084815883");
		...
		public void savechange() throws InterruptedException {
			...
			scroll.scrollIntoView(CancelButton);
			Thread.sleep(2000);
		}
		...
		public void ClickCancelButton() {
			WebElement CancelIt=wait.until(ExpectedConditions.elementToBeClickable(Cancelbtn));
			CancelIt.click();

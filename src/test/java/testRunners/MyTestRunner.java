...
@CucumberOptions(
    features = {"src/test/resources/features/PersonalVault_GeneralLegal.feature"},
    glue = {"parallel", "AppHooksMyTestRunner"},
    tags = "@tag0",
    publish = true,
...
public class MyTestRunner extends AbstractTestNGCucumberTests {
    ...
    @Test(dataProvider = "scenarios") // Assuming you have a data provider named "scenarios"
    public void runCucumberTest(int scenario) {
        super.scenarios();
    }
